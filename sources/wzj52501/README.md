...
第三批补充 Search 第 20–21 页与 DP 第 16–19、29–31、58、89、104、107、115 页，累计 36 页视觉修订。乌龟棋原式 `n+1` 与位移关系的矛盾单列为编者待核说明；DP 第 89 页数据范围在可见原页中无法确认，未从旧提取补入。对应上标候选已核对不等于整份讲义审核完成。
