# Setter/NOI/Mock-3/bishop.cpp

来源 ID：`wzj52501-d225dd1c0d50fc85`

[固定版本原件](https://github.com/wzj52501/awesome-competitive-olympiad-algorithms/blob/7b7a50a271b4a0773e1e046411fbd5bcb3c1f28e/Setter/NOI/Mock-3/bishop.cpp) · commit `7b7a50a271b4a0773e1e046411fbd5bcb3c1f28e`
...
int main() {
	...
	while(T--) {
		...
		printf("%d\n",(ll)P[Q.top().x][k]*pow(C(n,k),mod-2)%mod);
		Q.pop();
	}
	return ~~(0-0);
}
